-- Create process_inventory_transfer RPC function to atomically process stock transfer across stores
...
BEGIN
    ...
    -- 6. Insert System Log
    SELECT name INTO v_source_name FROM store_master WHERE id = p_source_store_id;
    SELECT name INTO v_dest_name FROM store_master WHERE id = p_destination_store_id;
